...
import com.git_trailblazer.v1.Commit;
import com.git_trailblazer.v1.Contributor;
import com.git_trailblazer.v1.FlagMaster;
import com.git_trailblazer.v1.github.CommitDetailsQuery;
...
public class CommitDetailsData {
    ...
    public CommitDetailsData(@NotNull Connector.QueryParams queryParams,
        ...
        if(FlagMaster.getInstance().getGLFlag()) {
            // TODO: get commit details from GitLab repos
        }
    }
}
